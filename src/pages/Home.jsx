...
// 1. IMPORTACIÓN DE IMÁGENES PARA LA SECCIÓN DE MÁS VENDIDOS (Verificadas en tu lista)
...
// 🟢 FUNCIÓN DE FORMATO CLP (Debe estar aquí para que el Home la use)
...
// 2. DATA DE PRODUCTOS MÁS VENDIDOS (Simulación en CLP)
        ...
        <div className="container my-4"> 
            ...
            <div className="row align-items-center mb-5"> 
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 mb-4"> 
                    ...
                    <p>Explora nuestra tienda y descubre todo lo que necesitas...</p>
                </div>
